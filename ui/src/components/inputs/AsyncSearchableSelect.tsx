// ui/src/components/inputs/AsyncSearchableSelect.tsx
import React, { useState, useEffect, useRef, useCallback } from 'react';
import { AsyncSelectDataSource } from '../../types/case';
import Portal from './Portal';
import axios from 'axios';
import '../../App.css';

interface AsyncSearchableSelectProps {
  dataSource: AsyncSelectDataSource;
  value?: number | string | null;
  onChange?: (value: number | string | null, option?: any) => void;
  placeholder?: string;
  disabled?: boolean;
  required?: boolean;
  className?: string;
...
export default function AsyncSearchableSelect({
  ...
  const fetchOptions = useCallback(async (search: string = '') => {
    ...
    try {
      ...
      const mappedOptions: OptionType[] = data.map((item: any) => ({
